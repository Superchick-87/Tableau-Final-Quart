...
<body>
    ...
    <div class="container">
        ...
        <div>
            <div class="quarter-final">
                ...
                <label for="score1_qf4">A</label>
                <input type="number" id="score1_qf4" name="score1_qf4" placeholder="" class="score" value="">
                <label for="score1_qf4R">R</label>
                <input type="number" id="score1_qf4R" name="score1_qf4R" placeholder="" class="score" value="">
                <br>
                ...
                <label for="score2_qf4">A</label>
                <input type="number" id="score2_qf4" name="score2_qf4" placeholder="" class="score">
                <label for="score2_qf4R">R</label>
                <input type="number" id="score2_qf4R" name="score2_qf4R" placeholder="" class="score">
            </div>
            <div class="quarter-final">
                ...
                <label for="score1_qf1">A</label>
                <input type="number" id="score1_qf1" name="score1_qf1" placeholder="" class="score">
                <label for="score1_qf1R">R</label>
                <input type="number" id="score1_qf1R" name="score1_qf1R" placeholder="" class="score">
                <br>
                <img id="team2_qf1-logo" alt="">
                <input type="text" id="team2_qf1" readonly placeholder="Équipe 2" class="equipe" value="Harlequins">
                <label for="score2_qf1">A</label>
                <input type="number" id="score2_qf1" name="score2_qf1" placeholder="" class="score">
                <label for="score2_qf1R">R</label>
                <input type="number" id="score2_qf1R" name="score2_qf1R" placeholder="" class="score">
            </div>
        </div>
        ...
        <div>
            <div class="quarter-final">
                ...
                <label for="score1_qf2">A</label>
                <input type="number" id="score1_qf2" name="score1_qf2" placeholder="" class="score">
                <label for="score1_qf2R">R</label>
                <input type="number" id="score1_qf2R" name="score1_qf2R" placeholder="" class="score">
                <br>
                <img id="team2_qf2-logo" alt="">
                <input type="text" id="team2_qf2" readonly placeholder="Équipe 2" class="equipe">
                <label for="score2_qf2">A</label>
                <input type="number" id="score2_qf2" name="score2_qf2" placeholder="" class="score">
                <label for="score2_qf2R">R</label>
                <input type="number" id="score2_qf2R" name="score2_qf2R" placeholder="" class="score">
            </div>
            <div class="quarter-final">
                ...
                <label for="score1_qf3">A</label>
                <input type="number" id="score1_qf3" name="score1_qf3" placeholder="" class="score">
                <label for="score1_qf3R">R</label>
                <input type="number" id="score1_qf3R" name="score1_qf3R" placeholder="" class="score">
                <br>
                <img id="team2_qf3-logo" alt="">
                <input type="text" id="team2_qf3" readonly placeholder="Équipe 2" class="equipe">
                <label for="score2_qf3">A</label>
                <input type="number" id="score2_qf3" name="score2_qf3" placeholder="" class="score">
                <label for="score2_qf3R">R</label>
                <input type="number" id="score2_qf3R" name="score2_qf3R" placeholder="" class="score">
            </div>
        </div>
    </div>
    <div class="final">
            ...
            fetch('datas_' + camelize(competition) + '.csv')
                ...
                .then(data => {
                    ...
                    for (let i = 0; i < 4; i++) {
                        ...
                        const score1QFR = columns[4];
                        const equipe2QF = columns[5];
                        const score2QF = columns[6];
                        const score2QFR = columns[7];
                        ...
                        document.getElementById(`score1_qf${i + 1}R`).value = score1QFR;
                        document.getElementById(`team2_qf${i + 1}`).value = equipe2QF;
                        document.getElementById(`score2_qf${i + 1}`).value = score2QF;
                        document.getElementById(`score2_qf${i + 1}R`).value = score2QFR;
    ...
    <script>
        ...
        function updateSemiFinals() {
            ...
            const score1_qf1R = Number(document.getElementById('score1_qf1R').value);
            const score2_qf1 = Number(document.getElementById('score2_qf1').value);
            const score2_qf1R = Number(document.getElementById('score2_qf1R').value);
            const score1_qf2 = Number(document.getElementById('score1_qf2').value);
            const score1_qf2R = Number(document.getElementById('score1_qf2R').value);
            const score2_qf2 = Number(document.getElementById('score2_qf2').value);
            const score2_qf2R = Number(document.getElementById('score2_qf2R').value);
            const score1_qf3 = Number(document.getElementById('score1_qf3').value);
            const score1_qf3R = Number(document.getElementById('score1_qf3R').value);
            const score2_qf3 = Number(document.getElementById('score2_qf3').value);
            const score2_qf3R = Number(document.getElementById('score2_qf3R').value);
            const score1_qf4 = Number(document.getElementById('score1_qf4').value);
            const score1_qf4R = Number(document.getElementById('score1_qf4R').value);
            const score2_qf4 = Number(document.getElementById('score2_qf4').value);
            const score2_qf4R = Number(document.getElementById('score2_qf4R').value);

            // Vérifier si tous les scores des quarts de finale sont renseignés
            if (!isNaN(score1_qf1) && !isNaN(score2_qf1R) && !isNaN(score2_qf1) && !isNaN(score2_qf1R) && !isNaN(score1_qf4) && !isNaN(score1_qf4R) && !isNaN(score2_qf4) && !isNaN(score2_qf4R)) {
                // Mettre à jour les demi-finales 1
                if ((score1_qf4 + score1_qf4R) > (score2_qf4 + score2_qf4R)) {
                ...
                if ((score1_qf1 + score1_qf1R) > (score2_qf1 + score2_qf1R)) {
            ...
            if (!isNaN(score1_qf2) && !isNaN(score1_qf2R) && !isNaN(score2_qf2) && !isNaN(score2_qf2R) && !isNaN(score1_qf3) && !isNaN(score1_qf3R) && !isNaN(score2_qf3) && !isNaN(score2_qf3R)) {
                if ((score1_qf2 + score1_qf2R) > (score2_qf2 + score2_qf2R)) {
                ...
                if ((score1_qf3 + score1_qf3R) > (score2_qf3 + score2_qf3R)) {
